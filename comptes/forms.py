...
class SignupForm(authtoolsforms.UserCreationForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Field("name", placeholder="Nom d'utilisateur ou pseudo"),
            Field("password1", placeholder="Minimum 8 en chiffres et lettres"),
            Field("password2", placeholder="Repeter"),
            Submit("sign_up", "Incription", css_class="btn btn-lg btn-danger btn-block"),
        )
    class Meta:
        model = User
