...
class SubscriberForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper = FormHelper()
        self.helper.form_tag = False
        self.helper.form_id = "user-reg-form"
        self.helper.form_method = 'post'
        self.fields["address_one"].required = True
        self.fields['city'].required = True
        self.fields['state'].required = True
        self.fields['stripe_id'].required = True
        self.helper.layout = Layout(
            Field("user_rec"),
            Field("address_one"),
            Field("address_two"),
            ...
            Field("state"),
            Field("stripe_id"),
            Button("update", "Confirmer", css_class="btn-success"),
        )
    class Meta:
        model = models.Subscriber
        fields = ["user_rec", "address_one", "address_two", "city", "state", "stripe_id"]
